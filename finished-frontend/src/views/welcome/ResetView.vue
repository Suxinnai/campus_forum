...
<template>
  <div class="reset-page">
    <div class="header">
      ...
      <div class="subtitle">输入您的注册邮箱以重置密码</div>
    </div>
    ...
    <div class="form-container">
      <el-form ref="formRef" :model="form" :rules="rules">
        ...
        <el-row :gutter="10">
          <el-col :span="16">
            <el-form-item prop="code">
              <el-input v-model="form.code" maxlength="6" placeholder="验证码" :prefix-icon="Key"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item>
        ...
        <el-form-item prop="password">
          <el-input v-model="form.password" type="password" show-password placeholder="新密码" :prefix-icon="Lock"/>
        </el-form-item>
        
        <el-form-item prop="repeat_password">
          <el-input v-model="form.repeat_password" type="password" show-password placeholder="确认新密码" :prefix-icon="Lock"/>
        </el-form-item>
      </el-form>
